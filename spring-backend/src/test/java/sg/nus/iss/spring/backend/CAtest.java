...
@Bean
CommandLineRunner CommandLineRun (CartRepository cartRepo, ProductRepository prodRepo, CategoryRepository catRepo, UserRepository userRepo, CartService cartService, PaymentTypeRepository payRepo) {
	return args ->{
