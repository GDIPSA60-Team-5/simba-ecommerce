const Contact = () => {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="w-[50%] mx-auto grid grid-cols-3 gap-4 mb-16">
                <div className="flex flex-col border border-red-800 items-center p-4 space-y-4">
                ...
                <div className="flex flex-col border border-red-800 items-center p-4 space-y-4">
                    ...
                    <p className="text-gray-600 mb-2">Visit our book store</p>
                    <p className="font-medium">25 Heng Mui Keng Terrace</p>
